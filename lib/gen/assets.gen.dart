...
class $AssetsImagesPngGen {
  ...
  /// File path: assets/images/png/qalla_app_icon.png
  AssetGenImage get qallaAppIcon =>
      const AssetGenImage('assets/images/png/qalla_app_icon.png');

  /// List of all assets
  List<AssetGenImage> get values => [logo, qallaAppIcon];
}
