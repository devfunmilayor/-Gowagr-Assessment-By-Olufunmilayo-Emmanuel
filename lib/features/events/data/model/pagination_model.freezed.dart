...
class _$PaginationModelImpl extends _PaginationModel {
  ...
  @override
  String toString() {
    return 'PaginationModel(page: $page, size: $size, totalCount: $totalCount, lastPage: $lastPage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, page, size, totalCount, lastPage);
...
abstract class _PaginationModel extends PaginationModel {
  const factory _PaginationModel(
      ...
      required final int lastPage}) = _$PaginationModelImpl;
